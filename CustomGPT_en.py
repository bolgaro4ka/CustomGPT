...
author=customtkinter.CTkButton(root, text="By Bolgaro4ka", width=415, fg_color="black", text_color="white", image= gitlogo, command=lambda: webbrowser.open('https://github.com/bolgaro4ka'))
